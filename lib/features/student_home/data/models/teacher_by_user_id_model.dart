...
//
//     final teacherByUserIdModel = teacherByUserIdModelFromJson(jsonString);

import 'dart:convert';

TeacherByUserIdModel teacherByUserIdModelFromJson(String str) => TeacherByUserIdModel.fromJson(json.decode(str));

String teacherByUserIdModelToJson(TeacherByUserIdModel data) => json.encode(data.toJson());

class TeacherByUserIdModel {
  User user;

  TeacherByUserIdModel({
    required this.user,
  });

  factory TeacherByUserIdModel.fromJson(Map<String, dynamic> json) => TeacherByUserIdModel(
