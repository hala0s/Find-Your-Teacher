...
TeacherProfileModel completeRegisterModelFromJson(String str) => TeacherProfileModel.fromJson(json.decode(str));

String completeRegisterModelToJson(TeacherProfileModel data) => json.encode(data.toJson());
