...
//
//     final teacherByIdModel = teacherByIdModelFromJson(jsonString);

import 'dart:convert';

TeacherByIdModel teacherByIdModelFromJson(String str) => TeacherByIdModel.fromJson(json.decode(str));

String teacherByIdModelToJson(TeacherByIdModel data) => json.encode(data.toJson());

class TeacherByIdModel {
  List<User> users;
  int totalCount;
  int documentCount;
  ...
  factory TeacherByIdModel.fromJson(Map<String, dynamic> json) => TeacherByIdModel(
